...
function AdminSidebar() {
  ...
  return (
    <div className="flex flex-col w-[250px] h-screen p-4 bg-brown max-w-[250px]">
      ...
      <nav className="flex flex-col gap-1">
        <Link to="/my/seller" className={linkClass}>사용자 관리</Link>
        <Link to="/my/seller" className={linkClass}>리뷰 관리</Link>
        <Link to="/my/seller" className={linkClass}>방송 관리</Link>
      </nav>

      <div className="border-t-2 border-gray-light my-4" />

      <nav className="flex flex-col gap-1">
        <Link to="/my/seller" className={linkClass}>팝업/배너 관리</Link>
        <Link to="/my/seller" className={linkClass}>팝엽/배너 등록</Link>
      </nav>

      <div className="border-t-2 border-gray-light my-4" />

      <nav className="flex flex-col gap-1">
        <Link to="/my/seller" className={linkClass}>상품 관리</Link>
      </nav>
    </div>
  );
}
