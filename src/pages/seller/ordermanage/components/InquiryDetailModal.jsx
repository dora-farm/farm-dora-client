...
const InquiryDetailModal = ({ inquiry, detail, loading, isOpen, onClose }) => {
  ...
  const questionAnswer = Array.isArray(detail) && detail.length > 0 ? detail[0] : null;
                    ...
                    <div className="p-4">
                      <div className="flex items-start">
                        <div className="flex-1">
                          <h4 className="font-medium text-gray-900 mb-1">{inquiry?.saleTitle || "-"}</h4>
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              <div className="space-y-6">
                <div className="mb-4">
                  <div className="flex justify-between items-center mb-2">
                    <h3 className="text-lg font-bold text-gray-800">문의 정보</h3>
                  ...
                  <div className="bg-amber-50 px-4 py-3 rounded-lg mb-4 flex justify-between items-center">
                    <div className="text-amber-900 text-sm flex items-center">
                      ...
                      작성자: <span className="font-semibold ml-1">{inquiry?.userName || "-"}</span>
                    </div>
                    <div className="flex items-center">
                      <span className="text-amber-900 text-sm mr-2">처리상태:</span>
                ...
                <div className="bg-white border border-gray-200 rounded-lg p-5 shadow-sm">
                  ...
                  <div className="mb-4">
                    ...
                    <div className="bg-gray-50 p-4 rounded-md text-gray-700 min-h-[100px]">
                      {inquiry?.questionContent || (questionAnswer?.answer || "-")}
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="mb-4">
                ...
                <div className="mt-6 p-4 bg-amber-50 rounded-lg text-sm text-amber-800">
                  ...
                  <ul className="list-disc pl-5 space-y-1">
                    ...
                    <li>답변 등록 시 문의 상태가 '답변완료'로 자동 변경됩니다.</li>
